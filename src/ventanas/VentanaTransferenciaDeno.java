 ...
 * @author danie
 */
public class VentanaTransferenciaDeno extends JFrame implements ActionListener, ItemListener{
    ...
    public VentanaTransferenciaDeno(ManejadorCliente mCliente, ManejadorDenominacion mDenominacion){
        this.mCliente = mCliente;
        this.mDenominacion = mDenominacion;
        this.configurarPantalla();
    }
    
    public VentanaTransferenciaDeno(){
        this.configurarPantalla();
    }
    ...
    public  void agregarComponentes(Container contentPane) {
        ...
        JLabel  lblDenominacion= new JLabel("Denominacion : ", JLabel.CENTER);
        ...
        btnAgregar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ...
                if(!cmbAmigosAsociados.getSelectedItem().toString().equals("Seleccionar") 
                        && !cmbDenominacion.getSelectedItem().toString().equals("Seleccionar") 
                    ){
                    ...
                    DenominacionBillete clDenominacion = mDenominacion.obtenerDenominacionXNombre(cmbDenominacion.getSelectedItem().toString());
